...
fn agent_summary_text(
    ...
    let text = match label {
        "blocked" => t!("mobile.blocked_count", count = count).to_string(),
        "done" => t!("mobile.done_count", count = count).to_string(),
        "working" => t!("mobile.working_count", count = count).to_string(),
        _ => t!("mobile.idle_count", count = count).to_string(),
    };
    match symbol {
