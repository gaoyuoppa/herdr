...
fn agent_command() -> Command {
    Command::new("agent")
        ...
        .subcommand(id_command(
            "get",
            "target",
            t!("cli.agent_get_about").to_string(),
        ))
        .subcommand(
            Command::new("read")
        ...
        .subcommand(
            Command::new("send-keys")
                .about(t!("cli.agent_send_about").to_string())
                .arg(required("target", "TARGET"))
        ...
        .subcommand(id_command(
            "focus",
            "target",
            t!("cli.agent_focus_about").to_string(),
        ))
        .subcommand(
            Command::new("wait")
...
fn pane_command() -> Command {
    Command::new("pane")
        ...
        .subcommand(id_command(
            "get",
            "pane_id",
            t!("cli.pane_get_about").to_string(),
        ))
        .subcommand(
            Command::new("layout")
        ...
        .subcommand(id_command(
            "close",
            "pane_id",
            t!("cli.pane_close_about").to_string(),
        ))
        .subcommand(
