...
This affects agent detection manifests, integration target schemas, integration configuration editing and assets, CLI/API serialization, settings recommendations, generated API documentation, and integration/detection tests. It introduces no new runtime dependency and no breaking change; `qwen` is an additive integration target.
